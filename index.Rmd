...
jw <- Corpus(DirSource(file.path(basedir, "Manuscripts/Publications/"), pattern="pdf"),
             readerControl = list(reader=readPDF))
jw2 <- txttrans(jw)
## summary(jw2)

png(filename = file.path(basedir, "Manuscripts/Publications/wordcloud.png"),
...
png(filename = file.path(basedir, "Manuscripts/Publications/wordcloud_banner.png"),
...
png(filename = file.path(basedir, "Manuscripts/Publications/wordcloud_small.png"),
...
million in funding. He has >70 publications and >5,000 citations (GS).
